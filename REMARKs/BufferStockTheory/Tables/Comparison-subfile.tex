...
\multirow{4}{75mm}{\thead{By Jensen's inequality, stronger than \\the PF-GIC. \\  Ensures consumers will not \\ expect to accumulate $\mRat$ unboundedly.}} \\
& \\
& \\
& \\
...
\multirow{3}{75mm}{\thead{By Jensen's inequality, stronger than the \\ PF-FVAC because for $\CRRA>1$ and \\ nondegenerate $\pShk$, $\Ex[\pShk^{1-\CRRA}] > 1$.} } \\
& \\
                           & \\
&  \\ \hline
\end{tabular}
