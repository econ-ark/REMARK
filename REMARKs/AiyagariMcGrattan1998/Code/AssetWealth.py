...
list_mLvl.append(aiyagari_consumer.state_now['aNrm']*aiyagari_consumer.state_now['pLvl'] )
list_aNrm.append(aiyagari_consumer.state_now['aNrm'])
funcs.append(aiyagari_consumer.solution[0].cFunc)
...
my_file_path = os.path.dirname(os.path.abspath("AssetWealth.py"))
...
f = plt.figure()  
plt.hist(aNrm, bins=np.linspace(0,1.4,num=1000))
# make_figs('asset', True, False, '../Figures')
f.savefig(os.path.join(figures_dir, 'asset.pdf'))
f.savefig(os.path.join(figures_dir, 'asset.png'))
f.savefig(os.path.join(figures_dir, 'asset.svg'))

#Distribution of level of wealth
f = plt.figure()  
plt.hist(mLvl, bins=np.linspace(0,1.2,num=1000))
# make_figs('wealth', True, False, '../Figures')
f.savefig(os.path.join(figures_dir, 'wealth.pdf'))
f.savefig(os.path.join(figures_dir, 'wealth.png'))
f.savefig(os.path.join(figures_dir, 'wealth.svg'))