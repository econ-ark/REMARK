...
data_location = os.path.dirname(calibration_dir)
...
# Make a dictionary for the do_1
init_do_1 = {"CRRA":CRRA,
                "Rfree":1.01/(1.0 - 1.0/160.0),
...
init_market = {'LorenzBool': False,
               ...
               'Population':10000,     # Will get overwritten
               ...
               'AggShockBool':True    # Will get overwritten
               }
