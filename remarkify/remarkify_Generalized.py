...
structure for a repo in the REMARK repository. The structure is general
enough that it can accommodate a complete archive of a full paper 
(as, for example, with the BufferStockTheory REMARK).  Or it can 
contain any subset, perhaps including only the code that uses the
Econ-ARK toolkit

The desired structure of a repo in REMARK is as follows:

./[REMARK name]/        # For example, [REMARK name] might be cAndCwithStickyE
    Appendices/         # Directory that contain the necessary code and data to parameterize the model 
    ...
    Data/               # Directory that contains any raw data sources used for the paper
    Figures/            # Any figures created by the main code that appear in the paper 
    Tables/             # Any tables created by the main code
    Equations/          # LaTeX equations to share (e.g., between paper and slides)
...
./[REMARK name]/        # For example, [REMARK name] might be cAndCwithStickyE
    Appendices/         # Directory that contains any appendix material
    Calibration/        # Contains the necessary code and data to parameterize the model 
    Code/               # The main body of code for the paper
    Data/               # Directory that contains any raw data sources used for the paper
    Figures/            # Any figures created by the main code that appear in the paper 
    Tables/             # Any tables created by the main code
    Equations/          # LaTeX equations to share (e.g., between paper and slides)
...
stickyE_code_name_and_current_locations = {'target_module_root_name':"cAndCwithStickyE",
                    'current_appendices_location':"Appendices/",
